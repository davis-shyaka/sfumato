...
const Home = ({ navigation }) => {
  ...
  const fetchData = () => {
    ...
    client
      ...
      .then((responseJson) => {
        setRefreshing(false);
        currentData = currentData.push(responseJson.items);
  ...
  console.log("Outside the scope:", currentData);
      ...
      >
        ...
        >
          ...
          <View style={styles.discoverItemLocationWrapper}>
            <Entypo name="brush" size={14} color={colors.yellow} />
            <Text style={styles.discoverItemLocationText}>{item.artist}</Text>
          </View>
        </ImageBackground>
      </TouchableOpacity>
    );
